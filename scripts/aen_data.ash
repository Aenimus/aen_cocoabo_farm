...
int data_combat_worth() {
	return get_property("aen_combat_worth").to_int();
}

int data_cocoabo_combat_worth() {
	return get_property("aen_cocoabo_combat_worth").to_int();
}

int data_cocoabo_combat_worth_today() {
	return get_property("_aen_cocoabo_combat_worth_today").to_int();
}

void data_cocoabo_combat_worth_today_set(int worth) {
	set_property("_aen_cocoabo_combat_worth_today", worth);
}